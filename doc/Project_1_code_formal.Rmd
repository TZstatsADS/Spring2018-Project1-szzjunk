...
I used S&P 500 on behalf of the stock market return. The data, which is availible from 1950, is downloaded from Yahoo Finance. I computed the monthly rate of return and integrated them to the speechlist.
...
For the above plot, I used the topic data generated by the topic model to cluster the eight presidents. As can be seen from the picture, the grouping is in line with the president's term and party affiliation.
